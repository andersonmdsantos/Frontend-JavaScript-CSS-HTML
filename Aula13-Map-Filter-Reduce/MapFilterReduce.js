...
// MAP (Percorre todo o vetor e armazena o resultado na variavel distanciasEmKm)

const distanciasEmKm = distanciaEmMetros.map(distancia => distancia / 1000);
console.log("Distancia em KM: ", distanciasEmKm)

// FILTER  (Percorre todo o vetor, filtra o resultado mediante a condição e armazena na variável itensFiltrados)
